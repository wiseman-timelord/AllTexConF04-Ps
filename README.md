...
- Look into possibilities of multi-gpu processing, utilizing psd1 for splitting file lists, therein, possibilities of, timing both cards to determine effectiveness of each card, even a scoring system like average textures per second or something.
